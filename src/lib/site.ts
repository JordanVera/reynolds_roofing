...
export const site = {
  ...
  tagline: 'Full-service roofing for Houston',
  description:
    'Reynolds Roofing TX is a full-service residential and commercial roofing company serving Houston with roof replacement, repairs, metal roofs, tile roofs, siding, and seamless gutters.',
  url: process.env.NEXT_PUBLIC_SITE_URL ?? 'https://www.reynoldsroofingtx.com',
  phone: '832-321-5088',
  phoneHref: 'tel:+18323215088',
  email:
    process.env.NEXT_PUBLIC_FORMSUBMIT_EMAIL ?? 'william@reynoldsroofingtx.com',
  city: 'Katy',
  state: 'TX',
  region: 'Katy, TX',
...
export const office = site.locations[0];
