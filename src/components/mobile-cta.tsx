  ...
  return (
    ...
    >
      <div className="grid grid-cols-2 gap-2 p-3">
        ...
        <Link
          href="/contact"
          className="flex h-12 items-center justify-center gap-2 rounded-lg bg-primary text-sm font-semibold text-primary-foreground transition-opacity active:opacity-90"
        >
